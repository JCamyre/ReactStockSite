...
import { discontinuousTimeScaleProvider } from "react-financial-charts/scale";
import {
	OHLCTooltip,
...
import { ema, rsi, sma, atr } from "react-financial-charts/indicator";
import { fitWidth } from "react-financial-charts/helper";
// import { last } from "react-financial-charts/utils";
		...
		return (
			...
			>
				...
				>
					...
					<OHLCTooltip origin={[-40, 0]} fontSize={18}/>
